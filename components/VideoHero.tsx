        ...
        <div className="space-y-8">
          <div className="max-w-3xl space-y-6" data-reveal>
            ...
            <h1 className="text-4xl font-semibold text-foreground sm:text-5xl">
              Micro territory indicators shaping demand across sectors.
            </h1>
            <p className="max-w-xl text-base text-muted sm:text-lg">
              ...
              across your target geography.
            </p>
            <p className="text-sm font-semibold text-foreground">
              Reliable indicators with clear governance, consistent across territories.
            </p>
